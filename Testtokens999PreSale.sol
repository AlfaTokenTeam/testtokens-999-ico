...
import "./Testtokens999.sol";

contract Testtokens999PreSale {
    Testtokens999 public token;
    ...
    function Testtokens999PreSale(
        Testtokens999 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = Testtokens999(_token);
